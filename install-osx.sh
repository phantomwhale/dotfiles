...
stow --restow ag amp bat bin espanso git javascript kitty llm neovim opencode ruby skhd skills timetrap tinty todo yabai zsh 2> >(grep -v 'BUG in find_stowed_path? Absolute/relative mismatch' 1>&2)
