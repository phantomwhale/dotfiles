...
stow --restow ag bash bat bin espanso git javascript kitty neovim ruby skhd timetrap tinty todo yabai zsh 2> >(grep -v 'BUG in find_stowed_path? Absolute/relative mismatch' 1>&2)
